...
const animate = () => {
    ...
    document.getElementById('clickme').className = 'clickmeAnimation';
    setTimeout(() => {
        document.getElementById('contactMeArrow').classList.remove('contactMeArrowAnimation');
        document.getElementById('clickme').classList.remove('clickmeAnimation');
    }, 500);
}
...
return(
    ...
    <div id='clickme' style={ window.mobilecheck() ? { opacity: .5 } :  null  }>
            Click Me
        </div>
    </Fragment>
    )
